                ...
                <ul className="space-y-4">
                    {filteredRoommates.map((r, index) => (
                        <li key={index}
                            ...
                            <p className="flex items-center text-gray-600"><SmileIcon
                                className="w-4 h-4 mr-2 text-blue-500"/>{r.gender}</p>
                            <p className="flex items-center text-gray-600 mb-1"><GraduationCap
                                className="w-4 h-4 mr-2 text-indigo-500"/>{r.university}</p>
                            <p className="flex items-center text-gray-600"><HeartHandshake
                                className="w-4 h-4 mr-2 text-pink-500"/>{r.preference}</p>
                            <p className="flex items-center text-gray-600"><PhoneIcon
                                className="w-4 h-4 mr-2 text-blue-500"/>{r.contact_info}</p>
                            <p className="flex items-center text-gray-600"><BookMarkedIcon
                                className="w-4 h-4 mr-2 text-blue-500"/>{r.current_info}</p>
                            <p className="flex items-center text-gray-600"><HomeIcon
                                className="w-4 h-4 mr-2 text-blue-500"/>{r.current_home}</p>
                        </li>
                    ))}
                </ul>
            ) : (
